	        ...
	        <section class="section">
	          <div class="section-header">
	            ...
	            <div class="section-header-breadcrumb">
	              <div class="breadcrumb-item active">데이터</div>
		                ...
		                <div class="card">
		                  <div class="card-body">
		                    ...
		                    <div class="form-group row mb-4">
			                    <label class="col-form-label col-2">이미지 슬라이드</label>
			                    <div class="col-sm-10">
		                    ...
		                    <div class="form-group row mb-4">
		                      <div class="col-sm-4">
			                        <a href="/admin/mapping/index?mapperCode=${mapping.mapper.code}&memberCode=${memberCode}" class="btn btn-primary">
		                       ...
		                       <div class="col-sm-4 text-right">
		                       		<a href="/admin/mapping/delete?code=${mapping.code}&mapperCode=${mapping.mapper.code}" class="btn btn-danger delete">
	...
	$(document).ready(function(){
		...
		$("#submit").click(function() {
            ...
            request.done(function (data) {
            	 if (data == true) {
            		 window.location.href = "/admin/mapping/index?mapperCode=${mapping.mapper.code}&memberCode=${memberCode}";
                 } else if (data == false) {
