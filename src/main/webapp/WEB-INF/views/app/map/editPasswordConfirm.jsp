...
<script>
	$(document).ready(function() {
		...
		$(".Submit").click(function() {
			...
			var request = $.ajax({
	            url: "/app/map/editPasswordConfirm",
	            type : "POST",
	            dataType:'json',
	            contentType: 'application/json',
	            data:JSON.stringify({
	            	"mappingCode": String(${mappingCode}),
	        ...
	        request.done(function (data) {
	        	if(data.result == true){
	        		window.location.href = "/app/mapping/edit?code="+data.mappingCode+"&mapperCode="+data.mapperCode+"&key=" + data.key;
	        	}
